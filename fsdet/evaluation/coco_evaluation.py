...
class COCOEvaluator_FsDet(DatasetEvaluator):
    """
...
def _evaluate_predictions_on_coco(
    ...
    # evaluation for known categories
    if logger is not None and output_dir is not None:
        text_file_name = os.path.join(output_dir, 'ap.txt')
        ...
        _ = logger.handlers.pop(-1) # remove the handler
    else:
        coco_eval.summarize()
